	...
	<div class="content-wrapper">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<tr>
                    ...
                    <td>
									<a style="color: #F2BE22;" href="admin.php?p=editevent&menu_upd='.$row['id_event'].'"" class="edit"><i class="material-icons" data-toggle="tooltip"
											title="Edit">&#xE254;</i></a>
									<a style="color: #CD1818;" href="deleteevent.php?menu_del='.$row['id_event'].'" class="delete"><i class="material-icons"
