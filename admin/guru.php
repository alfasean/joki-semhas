	...
	<div class="content-wrapper">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<tr>
                    ...
                    <td>
									<a style="color: #F2BE22;" href="admin.php?p=editguru&menu_upd='.$row['id_guru'].'"" class="edit"><i class="material-icons" data-toggle="tooltip"
											title="Edit">&#xE254;</i></a>
									<a style="color: #CD1818;" href="deleteguru.php?menu_del='.$row['id_guru'].'" class="delete"><i class="material-icons"
